...
use crate::compile::semantic::types::ResolvedSet;
use arco_kdl::algebra::{BinaryOp, ComparisonOp, Expr, UnaryOp};
use arco_kdl::source::{DataDecl, LiteralValue, ModelDecl, SetDecl, SourceProgram};
...
fn resolve_subset_projection_position(
    set_decl: &SetDecl,
    tuple_index: &arco_kdl::source::IndexDecl,
