...
fn test_from_csc_builds_model() {
    let model = Model::from_csc(
        CscInput {
            ...
            col_ptrs: &[0, 1, 2],
            row_indices: &[0, 0],
            values: &[1.0_f64, 2.0_f64],
            var_lower: &[0.0_f64, 0.0_f64],
            var_upper: &[10.0_f64, 5.0_f64],
            con_lower: &[5.0_f64],
            con_upper: &[5.0_f64],
...
fn test_from_csc_only_stores_non_empty_columns() {
    let model = Model::from_csc(
        CscInput {
            ...
            row_indices: &[0, 1],
            values: &[1.0_f64, 2.0_f64],
            var_lower: &[0.0_f64, 0.0_f64, 0.0_f64],
            var_upper: &[1.0_f64, 1.0_f64, 1.0_f64],
            con_lower: &[0.0_f64, 0.0_f64],
            con_upper: &[1.0_f64, 1.0_f64],
