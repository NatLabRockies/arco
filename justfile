...
[group: 'hygiene']
script-test:
    uv run --no-project --with pytest --with pyyaml pytest scripts/test_bench.py scripts/test_build_python_wheel.py scripts/test_python_package_smoke.py scripts/test_kdl_overlay.py scripts/test_resolve_merged_release_candidate.py -q
