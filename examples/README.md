...
| Sparse net injection                   | `examples/sparse-net-injection/input.kdl`                                            | Sparse bus-level net injection pattern: combine reduced dispatch expressions with load that exists only on an existing-links subset, without densifying load to all buses. | Ready  |
