...
# Right-hand side of a reduction: one named axis or several.
AxisSelection: TypeAlias = "IndexSet | Sequence[IndexSet]"
# Numeric operand accepted elementwise against a labeled array.
NumericOperand: TypeAlias = "ParamArray | float | Sequence[float]"
# Any operand that carries model terms.
LinearOperand: TypeAlias = "VariableArray | ExprArray"
...
class Bounds:
    def __init__(
        self,
        lower: BoundValue | ParamArray | None = None,
        upper: BoundValue | ParamArray | None = None,
    ) -> None: ...
    @property
    def lower(self) -> BoundValue | ParamArray: ...
    @property
    def upper(self) -> BoundValue | ParamArray: ...
...
class VariableArray:
    ...
    def __radd__(self, other: LinearOperand | NumericOperand) -> ExprArray: ...
    def __sub__(self, other: LinearOperand | NumericOperand) -> ExprArray: ...
    def __rsub__(self, other: LinearOperand | NumericOperand) -> ExprArray: ...
    def __mul__(self, other: NumericOperand) -> ExprArray: ...
    def __rmul__(self, other: NumericOperand) -> ExprArray: ...
    def __truediv__(self, other: float) -> ExprArray: ...
    def __neg__(self) -> ExprArray: ...
    def __ge__(
        self, rhs: LinearOperand | NumericOperand | IndexSet
    ) -> ConstraintArray: ...
    def __le__(
        self, rhs: LinearOperand | NumericOperand | IndexSet
    ) -> ConstraintArray: ...
    ...
    # Summing every axis yields a scalar `Expr`; summing a subset keeps the
    # remaining axes in an `ExprArray`.
    ...
    # Summing every axis collapses to a scalar; summing a subset keeps the rest.
    @overload
    def sum(self, *, over: None = None) -> Expr: ...
    @overload
    def sum(self, *, over: AxisSelection) -> Expr | ExprArray: ...
    # Rank-preserving transforms always keep at least one axis.
    def cumsum(self, *, over: IndexSet) -> ExprArray: ...
    def diff(self, *, over: IndexSet) -> ExprArray: ...
